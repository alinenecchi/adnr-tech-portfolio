export const getThemeSelectorStyles = () => {
  return {
    ...
    icon: "w-4 h-4",
    dropdown:
      "absolute right-0 mt-2 w-64 bg-card-bg rounded-lg shadow-lg border border-card-border z-[100] transition-colors duration-300 max-h-80 overflow-y-auto lg:block",
    mobileDropdown:
