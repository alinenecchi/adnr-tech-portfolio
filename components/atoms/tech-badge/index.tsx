...
const techColors: Record<string, string> = {
  ...
  "React 18+": "bg-blue-100 text-blue-800 hover:bg-blue-200",
  "Next.js": "bg-gray-100 text-gray-800 hover:bg-gray-200",
  TypeScript: "bg-purple-100 text-purple-800 hover:bg-purple-200",
  ...
  // Tecnologias do projeto TMDB Movies
  "React Router": "bg-red-100 text-red-800 hover:bg-red-200",
  "Context API": "bg-indigo-100 text-indigo-800 hover:bg-indigo-200",
  Axios: "bg-teal-100 text-teal-800 hover:bg-teal-200",
  "CSS Modules": "bg-cyan-100 text-cyan-800 hover:bg-cyan-200",
  Jest: "bg-amber-100 text-amber-800 hover:bg-amber-200",
  "React Testing Library": "bg-rose-100 text-rose-800 hover:bg-rose-200",
  "TMDB API": "bg-emerald-100 text-emerald-800 hover:bg-emerald-200",
